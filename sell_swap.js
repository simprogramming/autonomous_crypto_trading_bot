...
const swapParams = {
    src: process.env.WETH_TOKEN_ADDRESS, // Token address of WETH
    dst: process.env.USDC_TOKEN_ADDRESS, // Token address of USDC
    amount: "50000000000000000", // 100$ 
    from: walletAddress,
...
async function main() {
    ...
    const ok = await yesno({
        question: "Do you want to send a transaction to approve trade with 1inch router? (yes/no)"
    });
